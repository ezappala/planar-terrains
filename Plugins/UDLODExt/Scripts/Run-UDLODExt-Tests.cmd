...
if "%TEST_FILTER%"=="" set "TEST_FILTER=UDLODExt"

if /I "%MODE%"=="coverage" (
    set "LOG_PATH=%PLUGIN_ROOT%\Saved\Coverage\UDLODExt-Automation.log"
) else (
    set "LOG_PATH=%PLUGIN_ROOT%\Saved\TestResults\UDLODExt-Automation.log"
)
