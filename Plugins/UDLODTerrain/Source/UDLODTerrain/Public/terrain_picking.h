...
//
// inline Picking* picking(
//     FRDGBuilder& gb,
//     const FSceneView& view,
//     const FRDGBufferRef picking_data_readback_buffer,
//     const FSceneTextures* scene_textures
// ) {
...
//     params->picking_data = gb.CreateUAV(picking_data_readback_buffer);
//     params->depth_texture = gb.CreateSRV(scene_textures->Depth.Resolve);
//     params->stencil_texture = scene_textures->Stencil;
//
//     return params;
// }
//
